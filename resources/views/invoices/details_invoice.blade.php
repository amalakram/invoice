...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Invoice Details </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                                        ...
                                        <div class="tab-pane" id="tab6">
                                            ...
                                            <div class="card card-statistics">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form method="post" action="{{ url('/invoices_attachments') }}"
