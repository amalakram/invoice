                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <button class="btn btn-outline-success btn-sm"
                                                    data-date="{{ $Overtime->date }}" data-Over_id="{{ $Overtime->id }}"
                                                    data-Employee_ID="{{ $Overtime->employee->Employee_ID }}"
													data-Employee_Name="{{ $Overtime->employee->Employee_Name }}"
                                                    data-No_of_hours="{{ $Overtime->No_of_hours }}"
                                                    data-Rate="{{ $Overtime->Rate }}"
													
													data-toggle="modal"
                                                    data-target="#edit_OverTime">Update</button>
                                            

                                           
                                                <button class="btn btn-outline-danger btn-sm " data-over_id="{{ $Overtime->id }}"
                                                    data-Employee_Name="{{ $Overtime->employees->Employee_Name }}" data-toggle="modal"
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">No_of_hours</label>  
							        <input class="form-control fc-datepicker"  id="No_of_hours" name="time_in" placeholder=""
                                    type="text"  required>   
                            </div>
        ...
        <!-- edit -->
        <div class="modal fade" id="edit_OverTime" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action='Attendance/update' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="title"> No_of_hours </Table>  :</label>
                                <input type="text" class="form-control" name="No_of_hours" id="No_of_hours">
                            </div>
                            
                            <div class="form-group">
                                <label for="title">Rate </Table>  :</label>
        ...
        <div class="modal fade" id="modaldemo9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="Overtime/destroy" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <p> Are you sure about the deletion process?</p><br>
                            <input type="hidden" name="Over_id" id="Over_id" value="">
...
<script src="{{ URL::asset('assets/js/table-data.js') }}"></script>
    ...
    <script>
        ...
        $('#modaldemo9').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var pro_id = button.data('Over_id')
            var product_name = button.data('Employee_Name')
            var modal = $(this)
            modal.find('.modal-body #Over_id').val(pro_id);
            modal.find('.modal-body #Employee_Name').val(Employee_Name);
        })
    </script>
@endsection
