							...
							<div class="card-body">
                                ...
                                @foreach ($Attendance as $Attendance)
                                    ...
                                    <tr>
                                        ...
                                        <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#edit_Attendance{{$Attendance->id}}">Update</button>
                                        <button class="btn btn-outline-danger btn-sm " data-toggle="modal"
                                                    data-target="#modaldemo9{{$Attendance->id}}">Delate</button>
