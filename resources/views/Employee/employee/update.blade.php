...
<div class="modal fade" id="edit_employee{{$Employee->id}}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="mb-3">
          <label for="title">Employee Mobile</Table>  :</label>
			<input type="text" class="form-control" name="Employee_Mobile" id="Employee_Mobile" value="{{ $Employee->Employee_Mobile }}">
          </div>

          <div class="mb-3">
          <label for="title">Employee Position</Table>  :</label>
          <input type="text" class="form-control" name="Employee_Position" id="Employee_Position" value="{{ $Employee->Employee_Position }}">
          </div>  

          <div class="mb-3">
          <label for="title">Member_Since</Table>  :</label>
		 <input type="text" class="form-control" name="Member_Since" id="Member_Since"  value="{{ $Employee->Employee_Position }}">
          </div>

          <div class="mb-3">
          <label for="title">Salary</Table>  :</label>
