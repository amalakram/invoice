...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Petty Cash</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Petty Cashlist</span>
						</div>
					</div>
							...
							<div class="card-body">
                                ...
                                @foreach ($PettyCash as $PettyCash)
                                    ...
                                    <tr>
                                        ...
                                        <button class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#edit_PettyCash{{$PettyCash->id}}">Update</button>

                                        <button class="btn btn-outline-danger btn-sm " data-toggle="modal"
                                                    data-target="#modaldemo96{{$PettyCash->id}}">Archive</button>

                                        <button class="btn btn-outline-danger btn-sm " data-toggle="modal"
                                                    data-target="#modaldemo9{{$PettyCash->id}}">Delate</button>
