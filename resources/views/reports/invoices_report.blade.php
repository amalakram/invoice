...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  Invoices Report 
                </span>
        </div>
    </div>
</div>
        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio" type="radio" value="1" id="type_div"> <span>Search by type
                                Invoice
                                </span></label>
                    </div>
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>Search by invoice number
                            </span></label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10"> Specify the type of invoice </p><select class="form-control select2" name="type"
                                required>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><a href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->invoice_number }} </a></td>
