...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Quotation</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Quotation list</span>
						</div>
					</div>
...
@section('content')
				...
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<a href="{{route('Quotation.create')}}" class="btn btn-primary ml-auto" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp;Add Quotation</a>

                                <a class="btn btn-primary ml-auto" href="{{ url('export_quotation') }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href=" {{ url('edit_quotation') }}/{{ $quotation->id }}"> <i
                                                                 class="las la-pen"></i>&nbsp;&nbsp;Edit Quotation
                                                            </a>
                                                        ...
                                                        <a class="dropdown-item" href="{{ URL::route('show_quotation', [$quotation->id]) }}"><i
                                                                class="text-success fas fa-print"></i>&nbsp;&nbsp;show Quotation
           ...
           <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('Quotation.destroy', 'test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                </div>
    ...
    <div class="modal fade" id="Transfer_quotation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Archive Quotation </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <form action="{{ route('Quotation.destroy', 'test') }}" method="post">
